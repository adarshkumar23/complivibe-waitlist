    ...
    <section className="relative px-5 py-20 sm:px-8 sm:py-28">
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="mt-14 grid grid-cols-2 gap-5 lg:grid-cols-4">
          {METRICS.map((m, i) => (
            <RevealOnScroll key={m.label} delay={(i % 4) * 0.1} direction="scale" className="h-full">
              <TiltCard className="glass flex h-full flex-col items-center justify-center p-7 text-center">
                <AnimatedNumber
                  value={m.value}
                  suffix={m.suffix}
                  duration={m.duration}
                  className="text-4xl font-extrabold gradient-text sm:text-5xl"
                />
        ...
        <RevealOnScroll delay={0.15} direction="up" className="mx-auto mt-10 max-w-3xl">
          <div className="glass-strong relative p-8 sm:p-10">
            <Quote
              size={40}
